...
(function () {
  ...
  function buildWorkbookBytes({ matched, needsReview, subtotals, summary, mappings }) {
    ...
    XLSXLib.utils.book_append_sheet(wb, XLSXLib.utils.json_to_sheet(matchedToRows(matched, mappings)), 'Matched');
    XLSXLib.utils.book_append_sheet(wb, XLSXLib.utils.json_to_sheet(needsReviewToRows(needsReview)), 'Needs Review');
    XLSXLib.utils.book_append_sheet(wb, XLSXLib.utils.json_to_sheet(subtotalsToRows(subtotals)), 'Subtotals');
    XLSXLib.utils.book_append_sheet(wb, XLSXLib.utils.json_to_sheet(summaryToRows(summary)), 'Summary');
